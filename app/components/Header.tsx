      ...
      >
        ...
        <div className="flex justify-between items-center gap-5">
          ...
          <nav className="flex gap-[2.778vw] items-center xl:w-[60%]">
            <img src={logoDark} alt="One Media" className="w-[120px] md:w-[160px]" />
        ...
        <div className={`mobile-menu ${menuOpen ? "active" : ""} lg:hidden`}>
          <ul className="flex flex-col gap-1 pt-4">
            <li><Link onClick={closeMenu} to="#section-courses" className="mobile-menu__link">Курси</Link></li>
            <li><Link onClick={closeMenu} to="#section-team" className="mobile-menu__link">Про нас</Link></li>
            <li><Link onClick={closeMenu} to="#section-form" className="mobile-menu__link">Хочу заробляти</Link></li>
