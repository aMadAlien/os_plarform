        ...
        <div className="flex flex-col gap-[30px] w-full max-w-[506px] max-md:mx-auto">
          ...
          >
            ...
            <p className="text-sm leading-6 text-[#5F6379]">
              ...
              <Link href={''} className="text-[#1A2040] font-medium hover:underline">Оферта</Link>
              <span> та </span>
              <Link href={''} className="text-[#1A2040] font-medium hover:underline">Політика конфіденційності</Link>
            </p>
          </button>
